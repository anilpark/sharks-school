<script lang="ts">
	...
	const cards = [
		...
		},
		{
			number: '02',
			title: 'Живі уроки',
			desc: 'за комунікативною методикою - говоримо з першого заняття',
			bg: '#dee6fd',
			titleColor: '#191360',
			descColor: '#191360',
			numColor: '#5677d5',
		...
		{
			number: '03',
			title: 'Сучасні інструменти',
			desc: 'Miro, Quizlet, інтерактивні вправи, квест карти, міні ігри',
			bg: '#f3e5fe',
			titleColor: '#4c1360',
			descColor: '#4c1360',
			numColor: '#a673d0',
		...
		{
			number: '04',
			title: 'Соц. активності',
			desc: 'Книжкові та розмовні клуби - більше практики й спілкування',
			bg: '#fff3eb',
			titleColor: '#573012',
			descColor: '#573012',
			numColor: '#c29369',
